...
def run_fn(fn_args: FnArgs) -> None:
    ...
    print(f"Total training samples: {num_train_samples}, Steps per epoch: {steps_per_epoch}")
    print(f"Total validation samples: {num_val_samples}, Validation steps: {validation_steps}")
